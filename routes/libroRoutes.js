...
const { validateLibroCreation, validateIdParam } = require('../middlewares/validations');
 ...
 */
router.get('/autor/:autorId', validateIdParam, libroController.getLibrosByAutor);
 ...
 */
router.get('/genero/:generoId', validateIdParam, libroController.getLibrosByGenero);
